        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <SignedIn>
            <div className="flex items-center gap-1 sm:gap-4">
              <NavLink 
                href="/submit" 
                className="text-sm font-medium text-rose-600 hover:text-rose-500 flex items-center gap-1.5 hidden xs:flex sm:flex"
              >
              ...
              <NavLink 
                href="/dashboard" 
                className="text-sm font-medium text-rose-600 hover:text-rose-500 hidden xs:inline-block sm:inline-block"
              >
                Dashboard
              </NavLink>
