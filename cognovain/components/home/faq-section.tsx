            ...
            <div className="bg-white rounded-[calc(0.75rem-1px)]">
              ...
              <AnimatePresence>
                {openItem === index && (
                  ...
                  >
                    <div className="px-6 pb-5 pt-2 text-base text-gray-700 border-t border-gray-100 bg-gray-200 dark:bg-gray-700 dark:text-gray-200 rounded-b-[calc(0.7rem-1px)] shadow-inner">
                      <p>{item.answer}</p>
                    </div>
                  </motion.div>
                )}
